...
## Instructions
This repository has folders for each of the videos in the course. Most of the course will use the files in the **main** branch. Later in the course there is an opportunity to use different branches in this reposititory.
...
## Branches
The branches or folders are structured to correspond to the videos in the course. The naming convention is `CHAPTER#_MOVIE#`. As an example, the branch named `02_03` corresponds to the second chapter and the third video in that chapter. 
